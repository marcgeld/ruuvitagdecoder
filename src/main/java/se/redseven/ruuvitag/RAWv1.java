 ...
 * @param humidity       Offset 1: Humidity (one lsb is 0.5%, e.g. 128 is 64%) Values above 100% indicate a fault in sensor. Value: 0…200
 * @param temperature    Offset 2,3: Temperature (MSB is sign, next 7 bits are decimal value), Temperature (fraction, 1/100.). Value1: -127…127, signed, Value 2: 0…99, unsigned
